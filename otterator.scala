package moorhouse{
  ...
  object Otter
  {//jgs' otter, thanks
    val ootttteerr = List(`torettorettoretto`(`o`(18), `toretto`(1), `o`(2), `ttoretto`(1))
    ,`torettorettoretto`(`o`(8), `rettoretto`(1), `etto`(1), `tto`(1), `to`(1), `tto`(1), `etto`(1), `rettoretto`(1), `o`(3), `toretto`(1), `o`(1), `ttoretto`(1))
    ,`torettorettoretto`(`o`(7), `ttoretto`(1), `o`(6), `torettoretto`(1), `ettorettoretto`(1), `o`(2),`toretto`(1),  `ttoretto`(1))
    ,`torettorettoretto`(`o`(6), `toretto`(1), `o`(4), `torettoretto`(1), `o`(3), `ttorettoretto`(1), `oretto`(1), `rettoretto`(1), `etto`(1), `rettoretto`(1))
    ...
    ,`torettorettoretto`(`o`(8), `to`(1), `rettoretto`(1), `o`(2), `to`(1), `o`(2), `ttoretto`(1), `retto`(2), `o`(7), `ettoretto`(1), `to`(1), `etto`(1), `rettoretto`(1), `ttoretto`(1), `o`(1), `rettorettoretto`(1), `ttoretto`(1),`toretto`(1))
    ...
    ,`torettorettoretto`(`o`(11), `to`(1), `rettoretto`(1), `o`(13), `toretto`(1), `o`(2), `ettoretto`(1),`ettorettoretto`(1), `etto`(1),`to`(1))
    ,`torettorettoretto`(`o`(13), `to`(1), `rettoretto`(1), `rettorettoretto`(1), `o`(8),  `etto`(1),`to`(1), `o`(4), `ttoretto`(1))
    ...
    implicit class otterator(val `::`: String) {
      ...
      }.++((ootttteerr map (o => o.tter)).foldLeft("")(_+"\n"+_) )
    }
  }
}